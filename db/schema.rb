...
ActiveRecord::Schema[7.1].define(version: 2024_12_13_081953) do
  ...
  create_table "billings", force: :cascade do |t|
    t.boolean "manual_payment", default: true, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "pay_later", default: true, null: false
    t.boolean "enable_integration", default: false, null: false
  end
  ...
  create_table "order_details", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["order_id", "part_id", "product_id"], name: "index_order_details_on_order_id_and_part_id_and_product_id", unique: true
