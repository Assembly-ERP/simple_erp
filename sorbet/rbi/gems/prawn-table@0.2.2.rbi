...
class Prawn::Document
  ...
  # source://prawn/2.5.0/lib/prawn/document.rb#227
  def initialize(options = T.unsafe(nil), &block); end

  # source://prawn/2.5.0/lib/prawn/document/bounding_box.rb#174
  def bounding_box(point, *args, &block); end

  # source://prawn/2.5.0/lib/prawn/document.rb#504
  def bounds; end

  # source://prawn/2.5.0/lib/prawn/document.rb#523
  def bounds=(bounding_box); end

  # source://prawn/2.5.0/lib/prawn/document/bounding_box.rb#191
  ...
  # source://prawn/2.5.0/lib/prawn/document/column_box.rb#34
  def column_box(*args, &block); end

  # source://prawn/2.5.0/lib/prawn/document.rb#415
  def cursor; end

  # source://prawn/2.5.0/lib/prawn/grid.rb#24
  def define_grid(options = T.unsafe(nil)); end

  # source://prawn/2.5.0/lib/prawn/document.rb#366
  def delete_page(index); end

  # source://prawn/2.5.0/lib/prawn/font.rb#291
  def find_font(name, options = T.unsafe(nil)); end

  # source://prawn/2.5.0/lib/prawn/document.rb#442
  def float; end

  # source://prawn/2.5.0/lib/prawn/font.rb#56
  def font(name = T.unsafe(nil), options = T.unsafe(nil)); end

  # source://prawn/2.5.0/lib/prawn/font.rb#212
  def font_families; end

  # source://prawn/2.5.0/lib/prawn/font.rb#314
  def font_registry; end

  # source://prawn/2.5.0/lib/prawn/font.rb#106
  def font_size(points = T.unsafe(nil)); end

  # source://prawn/2.5.0/lib/prawn/font.rb#119
  def font_size=(size); end

  # source://prawn/2.5.0/lib/prawn/document.rb#395
  def go_to_page(page_number); end

  # source://prawn/2.5.0/lib/prawn/grid.rb#50
  def grid(*args); end

  # source://prawn/2.5.0/lib/prawn/document.rb#700
  def group(*_arguments); end

  # source://prawn/2.5.0/lib/prawn/document.rb#615
  def indent(left, right = T.unsafe(nil), &block); end

  # source://prawn/2.5.0/lib/prawn/document.rb#767
  ...
  # source://prawn/2.5.0/lib/prawn/document.rb#109
  def margin_box; end

  # source://prawn/2.5.0/lib/prawn/document.rb#109
  def margin_box=(_arg0); end

  # source://prawn/2.5.0/lib/prawn/document.rb#113
  def margins; end

  # source://prawn/2.5.0/lib/prawn/document.rb#749
  def mask(*fields); end

  # source://prawn/2.5.0/lib/prawn/document.rb#423
  def move_cursor_to(new_y); end

  # source://prawn/2.5.0/lib/prawn/document.rb#541
  def move_down(amount); end

  # source://prawn/2.5.0/lib/prawn/document.rb#532
  def move_up(amount); end

  # source://prawn/2.5.0/lib/prawn/document.rb#652
  def number_pages(string, options = T.unsafe(nil)); end

  # source://prawn/2.5.0/lib/prawn/outline.rb#12
  def outline; end

  # source://prawn/2.5.0/lib/prawn/document.rb#592
  def pad(y); end

  # source://prawn/2.5.0/lib/prawn/document.rb#574
  def pad_bottom(y); end

  # source://prawn/2.5.0/lib/prawn/document.rb#557
  def pad_top(y); end

  # source://prawn/2.5.0/lib/prawn/document.rb#781
  def page; end

  # source://prawn/2.5.0/lib/prawn/document.rb#386
  def page_count; end

  # source://prawn/2.5.0/lib/prawn/document.rb#733
  def page_match?(page_filter, page_number); end

  # source://prawn/2.5.0/lib/prawn/document.rb#121
  def page_number; end

  # source://prawn/2.5.0/lib/prawn/document.rb#121
  def page_number=(_arg0); end

  # source://prawn/2.5.0/lib/prawn/document.rb#512
  def reference_bounds; end

  # source://prawn/2.5.0/lib/prawn/document.rb#456
  def render(*arguments); end

  # source://prawn/2.5.0/lib/prawn/document.rb#472
  def render_file(filename); end

  # source://prawn/2.5.0/lib/prawn/repeater.rb#77
  def repeat(page_filter, options = T.unsafe(nil), &block); end

  # source://prawn/2.5.0/lib/prawn/repeater.rb#10
  def repeaters; end

  # source://prawn/2.5.0/lib/prawn/font.rb#255
  def save_font; end

  # source://prawn/2.5.0/lib/prawn/font.rb#245
  def set_font(font, size = T.unsafe(nil)); end

  # source://prawn/2.5.0/lib/prawn/document/span.rb#31
  def span(width, options = T.unsafe(nil)); end

  # source://prawn/2.5.0/lib/prawn/document.rb#299
  def start_new_page(options = T.unsafe(nil)); end

  # source://prawn/2.5.0/lib/prawn/document.rb#778
  def state; end

  # source://prawn/2.5.0/lib/prawn/document.rb#778
  def state=(_arg0); end

  # source://prawn/2.5.0/lib/prawn/document.rb#127
  def text_formatter; end

  # source://prawn/2.5.0/lib/prawn/document.rb#127
  def text_formatter=(_arg0); end

  # source://prawn/2.5.0/lib/prawn/document.rb#709
  def transaction; end

  # source://prawn/2.5.0/lib/prawn/font.rb#150
  def width_of(string, options = T.unsafe(nil)); end

  # source://prawn/2.5.0/lib/prawn/document.rb#117
  def y; end

  # source://prawn/2.5.0/lib/prawn/document.rb#406
  def y=(new_y); end

  private

  # source://prawn/2.5.0/lib/prawn/document.rb#823
  def apply_margin_options(options); end

  # source://prawn/2.5.0/lib/prawn/document.rb#842
  def font_metric_cache; end

  # source://prawn/2.5.0/lib/prawn/document.rb#798
  def generate_margin_box; end

  # source://prawn/2.5.0/lib/prawn/document/bounding_box.rb#206
  def init_bounding_box(user_block, options = T.unsafe(nil)); end

  # source://prawn/2.5.0/lib/prawn/document/column_box.rb#43
  def init_column_box(user_block, options = T.unsafe(nil)); end

  # source://prawn/2.5.0/lib/prawn/grid.rb#445
  def multi_box(box1, box2); end

  # source://prawn/2.5.0/lib/prawn/grid.rb#441
  def single_box(rows, columns); end

  # source://prawn/2.5.0/lib/prawn/document.rb#789
  def use_graphic_settings(override_settings = T.unsafe(nil)); end

  # source://prawn/2.5.0/lib/prawn/font.rb#320
  def width_of_inline_formatted_string(string, options = T.unsafe(nil)); end

  # source://prawn/2.5.0/lib/prawn/font.rb#330
  def width_of_string(string, options = T.unsafe(nil)); end

  class << self
    # source://prawn/2.5.0/lib/prawn/document.rb#95
    def extensions; end

    # source://prawn/2.5.0/lib/prawn/document.rb#161
    def generate(filename, options = T.unsafe(nil), &block); end

    # source://prawn/2.5.0/lib/prawn/document.rb#100
...
class Prawn::Table
  ...
  #
  # source://prawn-table//lib/prawn/table.rb#470
...
class Prawn::Table::Cell
  ...
  # cell content.
  #
  # source://prawn-table//lib/prawn/table/cell.rb#726
...
class Prawn::Table::Cell::Text < ::Prawn::Table::Cell
  ...
  #
  # source://prawn-table//lib/prawn/table/cell/text.rb#67
  def draw_content; end
  ...
  #
  # source://prawn-table//lib/prawn/table/cell/text.rb#136
