...
module TTFunk::Subset
  class << self
    ...
    # @return [TTFunk::Subset::Unicode, TTFunk::Subset::Unicode8Bit, TTFunk::Subset::MacRoman, TTFunk::Subset::Windows1252]
    #
    # source://ttfunk//lib/ttfunk/subset.rb#18
...
# @api private
#
# source://ttfunk//lib/ttfunk/subset/base.rb#20
class TTFunk::Subset::Base
  # @api private
  # @param original [TTFunk::File]
  # @return [Base] a new instance of Base
  #
  # source://ttfunk//lib/ttfunk/subset/base.rb#33
  ...
  #
  # source://ttfunk//lib/ttfunk/subset/base.rb#98
  ...
  # @return [String]
  #
  # source://ttfunk//lib/ttfunk/subset/base.rb#63
  ...
  #
  # source://ttfunk//lib/ttfunk/subset/base.rb#70
  ...
  # TTFunk::Table::Glyf::Compound}] if original is a TrueType font
  # @return [Hash{Integer => TTFunk::Table::Cff::Charstring] if original is
  # a CFF-based OpenType font] Hash{Integer => TTFunk::Table::Cff::Charstring] if original is
  #   a CFF-based OpenType font
  #
  # source://ttfunk//lib/ttfunk/subset/base.rb#87
  def glyphs; end
  ...
  # @return [Boolean]
  #
  # source://ttfunk//lib/ttfunk/subset/base.rb#47
  ...
  #
  # source://ttfunk//lib/ttfunk/subset/base.rb#142
  ...
  # @return [Hash{Integer => Integer}]
  #
  # source://ttfunk//lib/ttfunk/subset/base.rb#117
  ...
  # @return [Hash{Integer => Integer}]
  #
  # source://ttfunk//lib/ttfunk/subset/base.rb#55
  ...
  # @return [Boolean]
  #
  # source://ttfunk//lib/ttfunk/subset/base.rb#40
  def unicode?; end
  ...
  #
  # source://ttfunk//lib/ttfunk/subset/base.rb#77
  ...
  # @api private
  #
  # source://ttfunk//lib/ttfunk/subset/base.rb#148
...
class TTFunk::Subset::CodePage < ::TTFunk::Subset::Base
  ...
  #
  # source://ttfunk//lib/ttfunk/subset/code_page.rb#47
  ...
  # @return [Integer]
  #
  # source://ttfunk//lib/ttfunk/subset/code_page.rb#38
  def code_page; end
  ...
  # @return [Boolean]
  #
  # source://ttfunk//lib/ttfunk/subset/code_page.rb#77
  ...
  #
  # source://ttfunk//lib/ttfunk/subset/code_page.rb#42
  def encoding; end
  ...
  # @return [Integer, nil]
  #
  # source://ttfunk//lib/ttfunk/subset/code_page.rb#94
  ...
  # @return [Boolean]
  #
  # source://ttfunk//lib/ttfunk/subset/code_page.rb#85
  ...
  #
  # source://ttfunk//lib/ttfunk/subset/code_page.rb#103
  ...
  # @return [Array<Integer>]
  #
  # source://ttfunk//lib/ttfunk/subset/code_page.rb#120
  ...
  # @return [Integer, nil]
  #
  # source://ttfunk//lib/ttfunk/subset/code_page.rb#128
  ...
  # @return [Hash]
  #
  # source://ttfunk//lib/ttfunk/subset/code_page.rb#59
  def to_unicode_map; end
  ...
  # @return [void]
  #
  # source://ttfunk//lib/ttfunk/subset/code_page.rb#68
  ...
  class << self
    ...
    # @return [Hash{Integer => Integer}]
    #
    # source://ttfunk//lib/ttfunk/subset/code_page.rb#16
...
class TTFunk::Subset::MacRoman < ::TTFunk::Subset::CodePage
  ...
  #
  # source://ttfunk//lib/ttfunk/subset/mac_roman.rb#12
  def initialize(original); end
end

# Unicode-based subset.
#
# source://ttfunk//lib/ttfunk/subset/unicode.rb#9
class TTFunk::Subset::Unicode < ::TTFunk::Subset::Base
  # @param original [TTFunk::File]
  # @return [Unicode] a new instance of Unicode
  #
  # source://ttfunk//lib/ttfunk/subset/unicode.rb#14
  def initialize(original); end
  ...
  # @return [true]
  #
  # source://ttfunk//lib/ttfunk/subset/unicode.rb#46
  ...
  # @return [Integer]
  #
  # source://ttfunk//lib/ttfunk/subset/unicode.rb#62
  def from_unicode(character); end
  ...
  # @return [Boolean]
  #
  # source://ttfunk//lib/ttfunk/subset/unicode.rb#54
  def includes?(character); end
  ...
  # @return [TTFunk::Table::Cmap]
  #
  # source://ttfunk//lib/ttfunk/subset/unicode.rb#69
  def new_cmap_table; end
  ...
  # @return [Array<Integer>]
  #
  # source://ttfunk//lib/ttfunk/subset/unicode.rb#85
  def original_glyph_ids; end
  ...
  # @return [Hash{Integer => Integer}]
  #
  # source://ttfunk//lib/ttfunk/subset/unicode.rb#30
  def to_unicode_map; end
  ...
  # @return [true]
  #
  # source://ttfunk//lib/ttfunk/subset/unicode.rb#23
  def unicode?; end
...
#
# source://ttfunk//lib/ttfunk/subset/unicode_8bit.rb#10
class TTFunk::Subset::Unicode8Bit < ::TTFunk::Subset::Base
  # @param original [TTFunk::File]
  # @return [Unicode8Bit] a new instance of Unicode8Bit
  #
  # source://ttfunk//lib/ttfunk/subset/unicode_8bit.rb#12
  def initialize(original); end
  ...
  # @return [Boolean]
  #
  # source://ttfunk//lib/ttfunk/subset/unicode_8bit.rb#49
  def covers?(character); end
  ...
  # @return [Integer]
  #
  # source://ttfunk//lib/ttfunk/subset/unicode_8bit.rb#65
  def from_unicode(character); end
  ...
  # @return [Boolean]
  #
  # source://ttfunk//lib/ttfunk/subset/unicode_8bit.rb#57
  def includes?(character); end
  ...
  # @return [TTFunk::Table::Cmap]
  #
  # source://ttfunk//lib/ttfunk/subset/unicode_8bit.rb#72
  def new_cmap_table; end
  ...
  # @return [Array<Integer>]
  #
  # source://ttfunk//lib/ttfunk/subset/unicode_8bit.rb#94
  def original_glyph_ids; end
  ...
  # @return [Hash{Integer => Integer}]
  #
  # source://ttfunk//lib/ttfunk/subset/unicode_8bit.rb#29
  def to_unicode_map; end
  ...
  # @return [void]
  #
  # source://ttfunk//lib/ttfunk/subset/unicode_8bit.rb#37
  def use(character); end
end
...
class TTFunk::Subset::Windows1252 < ::TTFunk::Subset::CodePage
  ...
  #
  # source://ttfunk//lib/ttfunk/subset/windows_1252.rb#12
  def initialize(original); end
end
...
#
# source://ttfunk//lib/ttfunk/subset_collection.rb#14
class TTFunk::SubsetCollection
  # @param original [TTFunk::File]
  # @return [SubsetCollection] a new instance of SubsetCollection
  #
  # source://ttfunk//lib/ttfunk/subset_collection.rb#16
  def initialize(original); end
  ...
  # @return [TTFunk::Subset::Unicode, TTFunk::Subset::Unicode8Bit, TTFunk::Subset::MacRoman, TTFunk::Subset::Windows1252]
  #
  # source://ttfunk//lib/ttfunk/subset_collection.rb#26
  def [](subset); end
  ...
  #
  # source://ttfunk//lib/ttfunk/subset_collection.rb#67
  ...
  # @return [void]
  #
  # source://ttfunk//lib/ttfunk/subset_collection.rb#35
...
class TTFunk::Table::Simple < ::TTFunk::Table
  ...
  # @return [Simple] a new instance of Simple
  #
  # source://ttfunk//lib/ttfunk/table/simple.rb#15
  ...
  # @return [String]
  #
  # source://ttfunk//lib/ttfunk/table/simple.rb#11
  def tag; end
end
