...
module Devise::Models::Authenticatable
  ...
  # source://devise/4.9.4/lib/devise/models/authenticatable.rb#93
  def active_for_authentication?; end

  # source://devise/4.9.4/lib/devise/models/authenticatable.rb#101
  def authenticatable_salt; end

  # source://devise/4.9.4/lib/devise/models/authenticatable.rb#97
  def inactive_message; end

  # source://devise/4.9.4/lib/devise/models/authenticatable.rb#124
  def inspect; end

  # source://devise/4.9.4/lib/devise/models/authenticatable.rb#109
  def serializable_hash(options = T.unsafe(nil)); end

  # source://devise/4.9.4/lib/devise/models/authenticatable.rb#89
  def unauthenticated_message; end

  # source://devise/4.9.4/lib/devise/models/authenticatable.rb#85
  def valid_for_authentication?; end

  protected

  # source://devise/4.9.4/lib/devise/models/authenticatable.rb#218
  def apply_to_attribute_or_variable(attr, method); end

  # source://devise/4.9.4/lib/devise/models/authenticatable.rb#133
  def devise_mailer; end

  # source://devise/4.9.4/lib/devise/models/authenticatable.rb#210
  def downcase_keys; end

  # source://devise/4.9.4/lib/devise/models/authenticatable.rb#200
  def send_devise_notification(notification, *args); end

  # source://devise/4.9.4/lib/devise/models/authenticatable.rb#214
  def strip_whitespace; end

  class << self
    # source://devise/4.9.4/lib/devise/models/authenticatable.rb#75
