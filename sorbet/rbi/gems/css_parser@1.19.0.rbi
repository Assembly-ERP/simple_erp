...
class CssParser::RuleSet
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#251
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#288
  def [](property); end
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#538
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#555
  def create_border_shorthand!; end

  # Looks for long format CSS dimensional properties (margin, padding, border-color, border-style and border-width)
  # and converts them into shorthand CSS properties.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#577
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#601
  ...
  # Leaves properties declared !important alone.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#628
  def create_list_style_shorthand!; end

  # Create shorthand declarations (e.g. +margin+ or +font+) whenever possible.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#504
  def create_shorthand!; end

  # Combine several properties into a shorthand one
  #
  # source://css_parser//lib/css_parser/rule_set.rb#514
  def create_shorthand_properties!(properties, shorthand_property); end

  # Return all declarations as a string.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#321
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#314
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#344
  def expand_background_shorthand!; end

  # Split shorthand border declarations (e.g. <tt>border: 1px red;</tt>)
  # Additional splitting happens in expand_dimensions_shorthand!
  #
  # source://css_parser//lib/css_parser/rule_set.rb#374
  def expand_border_shorthand!; end

  # Split shorthand dimensional declarations (e.g. <tt>margin: 0px auto;</tt>)
  # into their constituent parts.  Handles margin, padding, border-color, border-style and border-width.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#392
  def expand_dimensions_shorthand!; end

  # Convert shorthand font declarations (e.g. <tt>font: 300 italic 11px/14px verdana, helvetica, sans-serif;</tt>)
  # into their constituent parts.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#429
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#484
  def expand_list_style_shorthand!; end

  # Split shorthand declarations (e.g. +margin+ or +font+) into their constituent parts.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#331
  def expand_shorthand!; end

  # source://css_parser//lib/css_parser/rule_set.rb#366
  def extract_background_size_from(value); end

  # the local or remote location
  #
  # source://css_parser//lib/css_parser/rule_set.rb#235
  def filename; end
  ...
  # File offset range
  #
  # source://css_parser//lib/css_parser/rule_set.rb#233
  def offset; end
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#238
  def selectors; end

  # Integer with the specificity to use for this RuleSet.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#241
  def specificity; end
  ...
  # source://css_parser//lib/css_parser/rule_set.rb#636
  def compute_dimensions_shorthand(values); end

  # Returns the value of attribute declarations.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#634
  ...
  # source://css_parser//lib/css_parser/rule_set.rb#649
  ...
  # ++
  #
  # source://css_parser//lib/css_parser/rule_set.rb#684
  def parse_selectors!(selectors); end

  # source://css_parser//lib/css_parser/rule_set.rb#692
  def split_value_preserving_function_whitespace(value); end

  # @return [Boolean]
  #
  # source://css_parser//lib/css_parser/rule_set.rb#677
...
class CssParser::RuleSet::Declarations
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#68
  def initialize(declarations = T.unsafe(nil)); end

  # source://css_parser//lib/css_parser/rule_set.rb#208
  def ==(other); end
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#91
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#124
  ...
  # @return [Boolean]
  #
  # source://css_parser//lib/css_parser/rule_set.rb#111
  ...
  # @raise [ArgumentError]
  #
  # source://css_parser//lib/css_parser/rule_set.rb#142
  def replace_declaration!(property, replacements, preserve_importance: T.unsafe(nil)); end

  # source://css_parser//lib/css_parser/rule_set.rb#115
  def size; end

  # source://css_parser//lib/css_parser/rule_set.rb#197
  ...
  # Returns the value of attribute declarations.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#216
  def declarations; end
  ...
  # @param value the value to set the attribute declarations to.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#220
  def declarations=(_arg0); end

  # source://css_parser//lib/css_parser/rule_set.rb#222
...
class CssParser::RuleSet::Declarations::Value
  ...
  # source://css_parser//lib/css_parser/rule_set.rb#57
  def ==(other); end
  ...
  # source://css_parser//lib/css_parser/rule_set.rb#53
  def to_s; end
  ...
  # @raise [ArgumentError]
  #
  # source://css_parser//lib/css_parser/rule_set.rb#44
  def value=(value); end
end
