...
# This is an autogenerated file for dynamic methods in `Cart`.
# Please instead update this file by running `bin/tapioca dsl Cart`.
...
class Cart
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Cart).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.any(Integer, Float, BigDecimal)) }
    def average(column_name); end

    sig { params(block: T.nilable(T.proc.params(object: ::Cart).void)).returns(::Cart) }
    sig do
      params(
        attributes: T::Array[T.untyped],
        block: T.nilable(T.proc.params(object: ::Cart).void)
      ).returns(T::Array[::Cart])
    end
    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Cart).void)).returns(::Cart) }
    ...
    sig { params(column_name: NilClass, block: T.proc.params(object: ::Cart).void).returns(Integer) }
    ...
    sig do
      ...
      ).returns(T::Enumerable[::Cart])
    end
    sig { params(args: NilClass, block: T.proc.params(object: ::Cart).void).returns(T.nilable(::Cart)) }
    def find(args = nil, &block); end

    sig { params(args: T.untyped).returns(T.nilable(::Cart)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::Cart) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        order: Symbol,
        block: T.proc.params(object: ::Cart).void
      ).void
    end
    sig do
      params(
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.proc.params(object: T::Array[::Cart]).void
      ).void
    end
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::Cart]])
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::Cart)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::Cart) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::Cart) }
    def find_sole_by(arg, *args); end

    sig { returns(T.nilable(::Cart)) }
    sig { params(limit: Integer).returns(T::Array[::Cart]) }
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::Cart).returns(T.type_parameter(:U))
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Cart, T::Enumerable[T.any(::Cart, T::Enumerable[::Cart])])
    ...
    sig do
      params(
        records: T.any(::Cart, Integer, String, T::Enumerable[T.any(::Cart, Integer, String, T::Enumerable[::Cart])])
      ).returns(T::Array[::Cart])
    end
    ...
    sig do
      params(
        other_array: T.any(::Cart, T::Enumerable[T.any(::Cart, T::Enumerable[::Cart])])
      ).returns(T::Array[::Cart])
    end
