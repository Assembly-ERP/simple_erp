...
class Webhook
  ...
  module GeneratedAttributeMethods
    ...
    def saved_change_to_secret_token; end
    ...
    def secret_token=(value); end

    sig { returns(T::Boolean) }
    def secret_token?; end

    sig { returns(T.nilable(::String)) }
    def secret_token_before_last_save; end

    sig { returns(T.untyped) }
    def secret_token_before_type_cast; end

    sig { returns(T::Boolean) }
    def secret_token_came_from_user?; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def secret_token_change; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def secret_token_change_to_be_saved; end

    sig { params(from: T.nilable(::String), to: T.nilable(::String)).returns(T::Boolean) }
    def secret_token_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def secret_token_in_database; end

    sig { returns(T.nilable([T.nilable(::String), T.nilable(::String)])) }
    def secret_token_previous_change; end

    sig { params(from: T.nilable(::String), to: T.nilable(::String)).returns(T::Boolean) }
    def secret_token_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def secret_token_previously_was; end

    sig { returns(T.nilable(::String)) }
    def secret_token_was; end

    sig { void }
    def secret_token_will_change!; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_secret_token?; end
